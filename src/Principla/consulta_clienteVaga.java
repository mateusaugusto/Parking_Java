...
public class consulta_clienteVaga extends javax.swing.JInternalFrame {
    int IDcpf;
    ...
    public consulta_clienteVaga() {
       ...
       jTable2 = new javax.swing.JTable(model);
        ...
        String sentenca = "SELECT * FROM mydb.cliente_vagas Inner join cliente on cliente.id=cliente_id";
        try {
            ...
            while (rs.next()) {
                idVaga = rs.getString("vagas_id");
                nome = rs.getString("nome");
                cpf = rs.getString("cpf");
                model.insertRow ( j , new Object [] { nome,cpf,idVaga }) ;
                j++;
